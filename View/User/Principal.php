...
<html>
    ...
    <body>
        ...
        <section class="e-cards">
                ...
                <?php foreach ($articulos as $datos):?>
        <div class="container">
            <div class="card">
                <div class="imgBx">
                    <img src="data:image/jpg;base64,<?php echo base64_encode($datos->getImagen());?>"/>
                </div>
                <div class="contentBx">
                    ...
                    <div class="size">
                        <span>Codigo</span><br>
                        <span><?php echo $datos->getCodigo();?></span><br>
                    </div>
                    <div class="size">
                        <span>Nombre</span><br>
                        <span><?php echo $datos->getNombre();?></span><br>
                    </div>
                    <div class="size">
                        <span>Descripcion</span><br>
                        <span><?php echo $datos->getDescripcion();?></span><br>
                    </div>
                    <div class="size">
                        <span>Categoria</span><br>
                        <span><?php echo $datos->getCategoria();?></span><br>
                    </div>
                    <div class="size">
                        <span>Precio</span><br>
                        <span><?php echo $datos->getPrecio();?></span><br>
                    </div>
                    <a href="index.php?c=housecraft&a=viewCompra&codigo=<?=$datos->getCodigo();?>">Comprar</a>
                </div>
            </div>
        </div>
                <?php endforeach;?>
