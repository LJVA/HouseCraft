    ...
    <body>
        <ul>
            ...
            <li>
                ...
                <span class="estado">-----</span>
                <a href="index.php?c=admi&a=viewActualizar&codigo=<?=$datos->getCodigo();?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
            ...
            <li>
                ...
                <span class="estado">Estado</span>
                <span class="estado">Foto</span>
                <span class="estado">Ingreso</span>
                <a>Editar</a>
                <a>Eliminar</a>
                <a>Cambiar Estado</a>
            </li>
            <?php
                foreach ($arte as $datos):
            ?>
            <li>
                <span class="id"><?php echo $datos->getCodigo();?></span>
                <span class="apellidos"><?php echo $datos->getNombre();?></span>
                ...
                <a href="index.php?c=artesano&a=viewActualizar&codigo=<?=$datos->getCodigo();?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                <a href="index.php?c=artesano&a=Eliminar&codigo=<?=$datos->getCodigo();?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                <a href="index.php?c=artesano&a=Estado&codigo=<?=$datos->getCodigo();?>"><i class="fa fa-refresh" aria-hidden="true"></i></a>
            </li>
            <?php
                endforeach;
                }
